...
def predict_image(img_path, top_k=3):
    ...
    """
    try:
        model_path = "S:\\4th_sem\\PlantDoc\\PlantDoc_ver_2_model.h5"
        class_labels_path = "S:\\4th_sem\\PlantDoc\\class_labels.json"
        img_size = (224, 224)
    ...
    # test_image = "S:\\4th_sem\\PlantDoc\\Dataset\\Test\\TomatoYellowCurlVirus1.JPG"
